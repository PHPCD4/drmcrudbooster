...
<head>
    ...
    <link rel="stylesheet"
        href="{{ asset("vendor/crudbooster/assets/adminlte/dist/css/jvectormap/jquery-jvectormap.css")}}">
        ...
        <div class="content-wrapper">
            ...
            <div class="row">
                <div class="col-md-5">
                    ...
                    <div>
                        <div class="play-button" id="play_buttoniframeSuplieVideoModal"
                            style="position: relative;padding-top: 5px;text-align: right;margin-right: 7.5em;left: 0;">
                            <button class="btn pb-btn" style="margin: 0;background: orange;color: #fff;"
                                data-toggle="modal" data-target="#iframeSuplieVideoModalInvoice"><i
                                    class="fa fa-play-circle" aria-hidden="true"></i>
                                Play</button>
                            <!-- Modal -->
                            <div class="modal fade iframeSuplieVideoModal" id="iframeSuplieVideoModalInvoice"
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <iframe id="supliefocusvideoInvoice"
                                                src="{{ $iframe_url_invoice_settings }}" width="640" height="360"
                ...
                <div class="col-md-4">
                    ...
                    <div style="height: 0">
                        <div
                            style="position: relative;padding-top: 0px;text-align: right;margin-right: 20em;left: 0;top: 5px;">
                            <button class="btn pb-btn" style="margin: 0;background: orange;color: #fff;"
                                data-toggle="modal" data-target="#iframeSuplieVideoModalImport"><i
                                    class="fa fa-play-circle" aria-hidden="true"></i>
                                Play</button>
                            <!-- Modal -->
                            <div class="modal fade iframeSuplieVideoModal" id="iframeSuplieVideoModalImport"
                                tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        ...
                                        <div class="modal-body">
                                            <iframe id="supliefocusvideoImport" src="{{ $iframe_urlorder_Import }}"
                ...
                <div class="col-md-3">
                    ...
                    <div style="height: 0">
                        <div
                            style="position: relative;padding-top: 0px;text-align: right;margin-right: 1em;left: 0;top: 5px;">
                            <button class="btn pb-btn" style="margin: 0;background: orange;color: #fff;"
                                data-toggle="modal" data-target="#iframeSuplieVideoModalproducts_resend"><i
                                    class="fa fa-play-circle" aria-hidden="true"></i>
                                Products and Resend</button>
                            <!-- Modal -->
                            <div class="modal fade iframeSuplieVideoModal" id="iframeSuplieVideoModalproducts_resend"
                                tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        ...
                                        <div class="modal-body">
                                            <iframe id="supliefocusvideoproducts_resend"
                                                src="{{ $iframe_url_products_resend }}" width="640" height="360"
                                                frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="pull-right">
                            <div class="play-button" id="play_buttoniframeSuplieVideoModal"
                                style="position: relative;padding-top: 0px;text-align: right;left: 0;">
                                <button class="btn pb-btn" style="margin: 0;background: orange;color: #fff;"
                                    data-toggle="modal" data-target="#iframeImportNewProduct"><i
                                        class="fa fa-play-circle" aria-hidden="true"></i>
                            ...
                            <div class="modal fade iframeSuplieVideoModal" id="iframeImportNewProduct" tabindex="-1"
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <iframe id="" src="{{ $import_new_product }}" width="640" height="360"
                                                frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="pull-left" style="height: 0">
                            <div style="position: relative;padding-top: 0px;text-align: right;left: 0;">
                                <button class="btn pb-btn" style="margin: 0;background: orange;color: #fff;"
                                    data-toggle="modal" data-target="#iframeProduct_sync"><i class="fa fa-play-circle"
                                        aria-hidden="true"></i>
                                    product Sync</button>
                                <!-- Modal -->
                                <div class="modal fade iframeSuplieVideoModal" id="iframeProduct_sync" tabindex="-1"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <iframe id="" src="{{ $product_sync }}" width="640" height="360"
            ...
            ?>
                ...
                <h1>
                    ...
                    <a href="{{ CRUDBooster::mainpath('add').'?return_url='.urlencode(Request::fullUrl()).'&parent_id='.g('parent_id').'&parent_field='.$parent_field }}"
                        id='btn_add_new_data' class="btn btn-sm btn-orange"
                        title="{{trans('crudbooster.action_add_data') }}">
                        <i class="fa fa-plus-circle"></i>
                        {{ ($action_add_data_title)?:trans('crudbooster.action_add_data') }}
                    </a>
                    @endif
                    @endif
                    ...
                    <a href='{{$ib["url"]}}' id='{{Illuminate\Support\Str::slug($ib["label"])}}'
                        class='btn {{($ib['color'])?'btn-'.$ib['color']:'btn-primary'}} btn-sm' @if($ib['onClick'])
                        onClick='return {{$ib["onClick"]}}' @endif @if($ib['onMouseOver'])
                        onMouseOver='return {{$ib["onMouseOver"]}}' @endif @if($ib['onMouseOut'])
                        onMouseOut='return {{$ib["onMouseOut"]}}' @endif @if($ib['onKeyDown'])
                        onKeyDown='return {{$ib["onKeyDown"]}}' @endif @if($ib['onLoad'])
                ...
                @if ($iframe_url)
                <div class="play-button" id="play_buttoniframeSuplieVideoModal"
                    style="{{ request()->is('admin/fallback_calculation') ? 'margin-left: 6em;':'' }}">
                    <button class="btn pb-btn" style="margin: 0;background: orange;color: #fff;" data-toggle="modal"
                        data-target="#iframeSuplieVideoModal{{ $table }}"><i class="fa fa-play-circle"
                            aria-hidden="true"></i>
                        Play</button>
                    <!-- Modal -->
                    <div class="modal fade iframeSuplieVideoModal" id="iframeSuplieVideoModal{{ $table }}" tabindex="-1"
                        role="dialog" aria-labelledby="myModalLabel">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-body">
                                    <iframe id="supliefocusvideo{{ $table }}" src="{{ $iframe_url }}" width="640"
