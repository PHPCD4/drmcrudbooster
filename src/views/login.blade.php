...
<!-- HTML5 Shim and Respond.js IE8 support of HTML5 elements and media queries -->
    ...
    <style type="text/css">
        .login-page, .register-page {
            background:{{ CRUDBooster::getSetting("login_background_color")?:'#dddddd'}} url('{{ CRUDBooster::getSetting("login_background_image")?asset(CRUDBooster::getSetting("login_background_image")):asset('vendor/crudbooster/assets/background.jpg') }}');
...
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        <form autocomplete='off' action="{{ route('postLogin') }}" method="post">
            ...
            <div class='newlink'>
                <a href="{{url('page/impressum')}}" target="_new">{{trans("crudbooster.imprint")}}</a>
                <a href="{{url('page/agb')}}" target="_new">{{trans("crudbooster.general_terms")}}</a>
            </div>
        </form>
