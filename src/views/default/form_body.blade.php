...
?>
@if(file_exists(base_path('/vendor/shojol/drmcrudbooster/src/views/default/type_components/'.$type.'/asset.blade.php')))
...
if ($join && @$row) {
    ...
    $id_join_table = 'id_'.$join_table;
    $join_query_.$join_table = DB::table($join_table)->select($join_title)->where("id", $row->$id_join_table)->first();
...
?>
@if(file_exists(base_path('/vendor/shojol/drmcrudbooster/src/views/default/type_components/'.$type.'/component.blade.php')))
